...
if __name__ == '__main__':
    ...
    retr = RKDRetriever()
    ricName = '/.SSMI' #change your RIC name
    startTime = '2022-07-01T00:00:00' #change your StartTime
    endTime =   '2024-12-31T23:59:59'  #change your EndTime
    ...
    interdayResult.to_csv(f'{ricName}.csv')